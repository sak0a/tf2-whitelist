            ...
            <div class="ml-3">
                ...
                <div class="mt-3">
                    ...
                    <div class="p-3 bg-red-50 border border-red-200 rounded mb-4">
                        ...
                        <div class="mt-2">
                            <?php if (isset($_SESSION['steam_verified']) && $_SESSION['steam_verified'] === true): ?>
                                <a href="/logout?service=steam" class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-sm">
                                    Logout Steam
                                </a>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['discord_verified']) && $_SESSION['discord_verified'] === true): ?>
                                <a href="/logout?service=discord" class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-sm ml-2">
                                    Logout Discord
                                </a>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['email_verified']) && $_SESSION['email_verified'] === true): ?>
                                <a href="/logout?service=email" class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-sm ml-2">
                                    Logout Email
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <a href="/status" class="inline-block bg-black text-white font-bold py-2 px-6 rounded">
                        View Ban Details
                    </a>
                </div>
            </div>
            ...
            <div class="ml-3">
                ...
                <div class="mt-3">
                    ...
                    <div class="p-3 bg-yellow-50 border border-yellow-200 rounded mb-4">
                        ...
                        <div class="mt-2">
                            <?php if (isset($_SESSION['steam_verified']) && $_SESSION['steam_verified'] === true): ?>
                                <a href="/logout?service=steam" class="bg-yellow-600 hover:bg-yellow-700 text-white px-3 py-1 rounded text-sm">
                                    Logout Steam
                                </a>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['discord_verified']) && $_SESSION['discord_verified'] === true): ?>
                                <a href="/logout?service=discord" class="bg-yellow-600 hover:bg-yellow-700 text-white px-3 py-1 rounded text-sm ml-2">
                                    Logout Discord
                                </a>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['email_verified']) && $_SESSION['email_verified'] === true): ?>
                                <a href="/logout?service=email" class="bg-yellow-600 hover:bg-yellow-700 text-white px-3 py-1 rounded text-sm ml-2">
                                    Logout Email
                                </a>
                            <?php endif; ?>
                        </div>
            ...
            <div class="ml-3">
                ...
                <div class="mt-3">
                    ...
                    <div class="p-3 bg-green-50 border border-green-200 rounded mb-4">
                        ...
                        <div class="mt-2">
                            <?php if (isset($_SESSION['steam_verified']) && $_SESSION['steam_verified'] === true): ?>
                                <a href="/logout?service=steam" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm">
                                    Logout Steam
                                </a>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['discord_verified']) && $_SESSION['discord_verified'] === true): ?>
                                <a href="/logout?service=discord" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm ml-2">
                                    Logout Discord
                                </a>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['email_verified']) && $_SESSION['email_verified'] === true): ?>
                                <a href="/logout?service=email" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm ml-2">
                                    Logout Email
                                </a>
                            <?php endif; ?>
                        </div>
            ...
            <div class="mb-8 border rounded-lg p-6 bg-gray-50">
                ...
                <?php if ($discordVerified): ?>
                    <div class="flex items-center mb-4">
                        ...
                        <?php endif; ?>
                        <a href="/logout?service=discord" class="bg-red-600 hover:bg-red-700 text-white py-1 px-3 rounded text-sm flex items-center">
                ...
                <?php else: ?>
                    <div class="mb-6">
                        ...
                        <a href="/discord_auth" class="inline-flex items-center bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded auth-button">
                    ...
                    <?php if (isset($_SESSION['email_verified']) && $_SESSION['email_verified'] === true): ?>
                        ...
                        <div id="email_verification">
                            <div class="flex items-center mb-4">
                                ...
                                <a href="/logout?service=email" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm ml-3">
                                    Logout Email
                                </a>
                            </div>
                        </div>
            ...
            <div class="mb-8 border rounded-lg p-6 bg-gray-50">
                ...
                <?php if ($steamVerified): ?>
                    <div class="flex items-center mb-4">
                        ...
                        <?php endif; ?>
                        <a href="/logout?service=steam" class="bg-red-600 hover:bg-red-700 text-white py-1 px-3 rounded text-sm flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                            </svg>
                            Logout
                ...
                <?php else: ?>
                    <div class="mb-6">
                        ...
                        <a href="/steam_auth" class="inline-flex items-center bg-gray-800 hover:bg-gray-900 text-white font-bold py-3 px-6 rounded auth-button">
        ...
        if (isset($_GET['debug_action'])) {
            switch ($_GET['debug_action']) {
                ...
                case 'view-logs':
                    ...
                    echo '<a href="/" class="bg-gray-700 hover:bg-gray-600 px-3 py-1 rounded">Close</a>';
                    echo '</div>';
